...
// import scssVars from '../stylesheets/Header.scss';
...
export function Header() {
    ...
    useLayoutEffect(() => {
        ...
        //#region -------------------- moveActiveNavDiv --------------------

        const moveActiveNavDiv = () => {

            // console.log('');
            // console.log('------------------------- moveActiveNavDiv -------------------------');
        ...
        window.addEventListener('resize', moveActiveNavDiv);

        window.scrollTo(0, 0);

        // clean up function
        return () => {
            window.removeEventListener('resize', moveActiveNavDiv);
        }
