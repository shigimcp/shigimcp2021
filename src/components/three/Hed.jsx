...
function Text({ children, vAlign = 'center', hAlign = 'center', size = 1, color = '#0000ff', ...props }) {
    ...
    const font = useLoader(THREE.FontLoader, 'https://raw.githubusercontent.com/shigimcp/shigimcp2020-react/master/src/.github/fonts/AvenirNext/AvenirNextCyr-Light.json')
