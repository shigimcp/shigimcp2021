...
// REF: https://til.hashrocket.com/posts/sxbrscjuqu-share-scss-variables-with-javascript
// REF: https://medium.com/clover-platform-blog/modular-scss-and-why-you-need-it-6bb2d8c40fd8

// const bodyWidth = parseInt(scssVars.bodyWidth);
// const bodyMinWidth = parseInt(scssVars.bodyMinWidth);
// const bodyMaxWidth = parseInt(scssVars.bodyMaxWidth);

// console.log('');
// console.log('bodyWidth = ' + bodyWidth + '     bodyMinWidth = ' + bodyMinWidth + '     bodyMaxWidth = ' + bodyMaxWidth);
// console.log('(bodyWidth + bodyMinWidth + bodyMaxWidth) = ' + (bodyWidth + bodyMinWidth + bodyMaxWidth));
...
export const Header = () => {
    ...
    useLayoutEffect(() => {
        ...
        const setActiveNavDiv = () => {
            ...
            // gsap.set([activeNavDiv_Ref.current], { x: thisLocX, y: thisLocY, width: thisLocW });
        ...
        if (navLoc) {
            ...
            // gsap.to([activeNavDiv_Ref.current], { x: thisLocX, width: thisLocW, duration: 0.5 });
            // gsap.to([activeNavDiv_Ref.current], { x: thisLocX, y: thisLocY, width: thisLocW, duration: 0.5 });
    ...
    function WorkNavItem(props) {
        ...
        // console.log('----------  Header.jsx: WorkNavItem(props)  ----------');
        ...
        <div className='header' id='headerID'>
            ...
            <div className='hed' id='hedID'>
                ...
                <div className='contact'>
                    212.464.7989 &nbsp;
                    <a href='mailto:shigimcp@yahoo.com?Subject=Hi Shigi! I saw your website, and...'>shigimcp@yahoo.com</a>
                </div>
